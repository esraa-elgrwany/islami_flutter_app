    ...
    return Center(
      child: Column(
        children: [
          ...
          Text(AppLocalizations.of(context)!.suraName,style: Theme.of(context).textTheme.bodyMedium!.copyWith(
          ...
          Expanded(child:
           ...
           return InkWell(
             ...
             child: Center(child:
             Text(suraName[index],style: Theme.of(context).textTheme.bodySmall,)),
           );
